            ...
            switch (obj->getType()) {
                ...
                case SceneObjectType::ST_PERSPECTIVECAMERA:
                    ...
                    for (auto toDraw : *this) {
                        switch (toDraw->getType()) {
                            case SceneObjectType::ST_HEXAHEDRON:
                                // std::cout << "Drawing Hexahedron" << "\n";
                                PerspectiveCamera::drawHexahedron(*dynamic_cast<PerspectiveCamera*>(obj), renderer, *dynamic_cast<Hexahedron*>(toDraw), QColorConstants::Green, 1.0f);
                        }
                    }
                ...
                case SceneObjectType::ST_STEREOCAMERA:
                    ...
                    for (auto toDraw : *this) {
                        switch (toDraw->getType()) {
                            case SceneObjectType::ST_HEXAHEDRON:
                                StereoCamera::drawHexahedron(*dynamic_cast<StereoCamera *>(obj), renderer,
                    ...
                    StereoCamera::reconstruct(*dynamic_cast<StereoCamera *>(obj), renderer, QColorConstants::Red, 1.0f);
