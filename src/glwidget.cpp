...
GLWidget::GLWidget(QWidget* parent) : QOpenGLWidget(parent), pointSize(5)
{
    ...
    scene.push_back(new Hexahedron(QVector4D(1,1,9,1), 2,2, 2));
    scene.push_back(new Hexahedron(QVector4D(1,0.6,8,1), 0.5,0.5, 0.5));
    QVector4D upVector = QVector4D(0,1,0,0);
    scene.push_back(new Hexahedron(QVector4D(-30,30,300,1), 30,30, 30));

    scene.push_back(new StereoCamera(E1, QVector4D(0, 0, 1, 0), upVector, 2.0f, 3.0f, 0.5f));
